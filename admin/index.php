            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        <form id="adminLogin" class="login100-form validate-form">
                                        ...
                                        <div class="tab-pane active" id="tab5">
                                            <div class="wrap-input100 validate-input input-group"
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0"
                                                    name="adminEmail" type="email" placeholder="Email">
                                            </div>
                                            <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0"
                                                    name="adminPassword" type="password" placeholder="Password">
                                            </div>
                                            <div class="text-end pt-4">
                                                <p class="mb-0"><a href="forgot_pasword.php"
                                                        class="text-primary ms-1">Forgot Password?</a></p>
                                            </div>
                                            <div class="container-login100-form-btn">
                                                <a id="adminLoginBtn" href="" class="login100-form-btn btn-primary">
                                                    Login
                                                </a>
                                            </div>
