                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2">
                                        <div class="d-flex country">
                                            <a href="controller/logout.php" class="btn btn-outline-primary">Logout</a>
                                        </div>
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="dashboard.php"><i
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="generate_code.php"><i
                                        class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Generate
                                        code</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="manage_attendance.php"><i
                                        class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Manage
                                        Attendance</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="review_table.php"><i
                                        class="side-menu__icon fe fe-layers"></i><span
                                        class="side-menu__label">review</span></a>
                            </li>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Users details</h1>
                            <div>
                                <ol class="breadcrumb">
                                                ...
                                                <tbody id="programsbody">
                                                    ...
                                                    while ($info = mysqli_fetch_array($results)) {
                                                        echo '<tr>
                                                            ...
                                                            <td><button id="'.$info['id'].'" class="modal-effect btn btn-primary btnView" data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo"><span class="fe fe-eye"></span></button>
                                                        </tr>';
                                                    }
                                                ?>
                                                </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered " role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Program</h6><button aria-label="Close" class="btn-close"
