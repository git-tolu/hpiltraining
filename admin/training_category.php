                                ...
                                <div class="card">
                                    <div class="card-header  justify-content-between">
                                        ...
                                        <button class="modal-effect btn btn-primary btnView"
                                            ...
                                            href="#modaldemo">Add Category</button>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <?php
                                                        ...
                                                        while ($info = mysqli_fetch_array($results)) {
                                                            echo '<tr>
                                                                <td>'.$sn++.'</td>
                                                                <td>'.$info['category'].'</td>
                                                                <td><button id="'.$info['id'].'"  class="btn btn-danger btnDelete"><span class="fe fe-trash-2"></span></button></td>
                                                            </tr>';
                                                        }
                                                    ?>
                                                </tbody>
                    ...
                    <div class="modal-dialog modal-dialog-centered " role="document">
                        <div class="modal-content modal-content-demo">
                            <div class="modal-header">
                                <h6 class="modal-title">Add Category</h6><button aria-label="Close" class="btn-close"
                            ...
                            <div class="modal-footer text-center justify-content-center d-flex align-items-center">
                                <button id="generateBtn" class="btn btn-primary">Add Category</button> <button
