...
<head>
    ...
    <!-- TITLE -->
    <title>HPIL – Training Events </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header justify-content-between">
                                        ...
                                        href="#modaldemo">Add Training Course</button>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="file-datatable"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom-0">Title of training </th>
                                                        <th class="border-bottom-0">Category Of training</th>
                                                        <th class="border-bottom-0">Description Of training</th>
                                                        <th class="border-bottom-0">Amount Of training</th>
                                                ...
                                                <tbody id="programsbody">
                                                    ...
                                                    while ($info = mysqli_fetch_array($results)) {
                                                        echo '<tr>
                                                            ...
                                                            <button id="'.$info['id'].'"  class="btn btn-danger btnDelete"><span class="fe fe-trash-2"></span></button><button class="btn btn-primary" > <a href="print.php?id='.$info['id'].'"  target="_blank" class="text-white"><i class="fa fa-print" aria-hidden="true"></i> </a> </button></td>
                                                        </tr>';
                                                    }
                                                ?>
                                                </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered " role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Edit Training Course</h6><button aria-label="Close" class="btn-close"
                            data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="card">
                            <div class="card-header text-center justify-content-center aligin-items-center d-flex">
                                <div id="errors" style="border-radius: 50px;"
                                    class="bg-danger text-center justify-content-center aligin-items-center d-flex text-dark">
                                </div>
                            </div>
