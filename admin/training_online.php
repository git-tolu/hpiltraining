...
<head>
    ...
    <!-- TITLE -->
   <title>HPIL – Online Booking  </title>
...
<body class="app sidebar-mini ltr">
    ...
    <div class="page">
                                ...
                                <form id="generate">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Register Program</h3>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-label">Name of Program <span
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="date"
                                                            placeholder="date" autocomplete="username">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="file-datatable"
                                                class="table table-bordered  key-buttons border-bottom">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom-0 text-capitalize"> date_ordered </th>
                                                        <th class="border-bottom-0 text-capitalize"> grand_total </th>
                                                        <th class="border-bottom-0 text-capitalize"> Action </th>
                                                        
                                                    </tr>
                                                </thead>
                                                <tbody id="programsbody">
                                                    <?php
                                                    $sql="SELECT * FROM course_participant";
                                                    ...
                                                    while ($info = mysqli_fetch_array($results)) {
                                                        echo '<tr>
                                                            ...
                                                            <td><a id="'.$info['course_id'].'" class="modal-effect text-capitalize  btnView" data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8">'.$info['name'].'</a></td>
                                                            <td>'.$info['email'].'</td>
                                                            <td>'.$info['phoneno'].'</td>
                                                            ...
                                                            <td><button id="'.$info['course_id'].'" class="modal-effect btn btn-primary btnView" data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8">Details</button></td>
                                                            </tr>';
                                                    }
                                                ?>
                                                </tbody>
        ...
        <div class="modal fade" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered " style="width: 900px !important;" role="document">
                <div class="modal-content modal-content-demo" style="width: 900px !important;">
                    <div class="modal-header">
                        <h6 class="modal-title"> Training Course Details</h6><button aria-label="Close" class="btn-close"
        ...
        <div class="modal fade" id="modaldemo">
            <div class="modal-dialog modal-dialog-centered " role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Training Course</h6><button aria-label="Close" class="btn-close"
                            data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="generate">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Register Training Course</h3>
                                        </div>
                                        <div class="card-body">
                                            <div id="erro" style="border-radius: 50px;"
                                                class="bg-danger text-center justify-content-center align-items-center d-flex text-dark">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="form-label">Category Of training<span
                                                            ...
                                                            <select name="category" class="form-control" id="">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    $results=mysqli_query($conn, $sql);
                                                                    while ($info = mysqli_fetch_array($results)) {
                                                                        echo '<option value="'.$info['category'].'">'.$info['category'].'</option>
                                                                        ';
                                                                    }
                                                                ?>
                                                            </select>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="amount" class="form-control"
                                                            placeholder="Amount Of training">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#generateBtn").click(function (e) {
                e.preventDefault()
                formId = document.getElementById("generate");
                if ($('#generate')[0].checkValidity()) {
                    $("#generateBtn").val("please wait...")
                    $.ajax({
                        url: 'controller/training.php',
                        method: 'POST',
                        contentType: false,
                        processData: false,
                        cache: false,
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: 'controller/training.php',
                            method: 'POST',
                            data: { deleteONline: deleteONline },
                            success: function (response) {
                                // console.log(response)
                                Swal.fire({
                                    icon: 'success',
                                    text: 'You have successfully deleted a Course',
            ...
            $("#programUpdateBtn").click(function (e) {
                e.preventDefault()
                formId = document.getElementById("programUpdate");
