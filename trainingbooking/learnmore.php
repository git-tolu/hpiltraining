...
<body
	...
	<div class="btPageWrap" id="top">
					...
					<div class="bt_bb_wrapper">
						<section id="bt_bb_section638098d6679e8"
												...
												<div class="col-md-6"
													...
													<div class="bt_bb_column_content">
														...
														<div class="bt_bb_contact_form_7">
															<div  class="wpcf7" >
																<img src="../admin/controller/coursePic/<?= $result['cover_image'] ?>" style>
															</div>
														</div>
														<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal"
															data-bt-override-class="null"></div>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="txt-heading btn">Course description</div>
								<div>
									<a  class="btn btn-outline-danger " href="index.php?action=add&code=<?= $_GET['code'] ?>&id=<?=$result['id'] ?>">Go Back</a>
									<a id="btnEmpty" class="btn btn-outline-danger " href="learnmore.php?action=empty&id=<?=$result['id'] ?>">Empty Cart</a>
								</div>
                            </div>
                            <div class="m-2">
                                <div>
                                    <h6 class="card-title text-capitalize"><?= $result['title'] ?></h6>
                                    <small class="card-title text-capitalize"><?php echo "₦ " . number_format($result['amount'], 2); ?></small>
                                </div>
			...
			<table class="table table-border table-striped table-responsive table-sm  table-hover "  >
				...
				foreach ($_SESSION["cart_item"] as $item) {
					...
					<tr>
						...
						<td style="text-align:center;"><a href="learnmore.php?action=remove&code=<?php echo $item["code"]; ?>&id=<?=$result['id'] ?>"
        ...
        ?>
        <form action="learnmore.php?action=add&code=<?= $result['order_code'] ?>&id=<?=$result['id'] ?>" class="my-3" method="post">
            <div class="row">
                <div class="col-md-6">
