...
$bcourse= $_SESSION["bcourse"];
$email = $_SESSION["bemail"];
$phoneno = $_SESSION["bphone"];
$id = $_GET['id'];
...
<meta http-equiv="refresh" content="7; url=<?php echo"https://api.whatsapp.com/send?phone=2348035440310&text=Hello!%20I%20am%20$bname.%20I%20just%20booked%20for%20$bcourse%20online.%20%20Please%20feed%20me%20with%20more%20information%20respectively.%20"; ?>">
<head>
								...
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row">
												<div class="bt_bb_column col-xl-6 bt_bb_align_left  bt_bb_animation_fade_in move_up animate bt_bb_padding_double bt_bb_animation_fade_in bt_bb_animation_move_up animate"
													data-width="6" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														
														
																<h2><br><br>Successful!</h2>
	Thanks <?php echo"$bname for the booking. Please wait while you are redirected to one of our online representatives for a chat<br>"; ?>
	If you are not redirected in 7 seconds, please click the button below<br>
<a href="<?php echo"https://api.whatsapp.com/send?phone=2348035440310&text=Hello!%20I%20am%20$bname.%20I%20just%20booked%20for%20$bcourse%20online.%20%20Please%20feed%20me%20with%20more%20information%20respectively.%20"; ?>">	
<button  type="submit" class="btn btn-dark" style="border-radius: 50px; background: #dd0000;
				font-family: 'Montserrat',Arial,Helvetica,sans-serif; box-shadow: 0 -2px 0 0 rgba(24,24,24,.15) inset;background: red;color: #fff;padding: 1.125em 1.875em;-webkit-transition: all 300ms ease;-moz-transition: all 300ms ease;transition: all 300ms ease;font-weight: 700;display: inline-block;line-height: 1;">Chat Now</button> </a>
												...
												<div class="bt_bb_column col-xl-6 bt_bb_align_left bt_bb_vertical_align_middle bt_bb_animation_fade_in animate bt_bb_padding_normal bt_bb_mobile_align_to_both_edges bt_bb_animation_fade_in animate"
